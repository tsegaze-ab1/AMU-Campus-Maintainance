...
CREATE TABLE IF NOT EXISTS users (
    ...
    -- Keep staff for backward compatibility and add admin2 for role-based gateway.
    role ENUM('admin','admin2','technician','staff','student') NOT NULL DEFAULT 'student',
...
-- run these changes to support username/password role gateway and admin2 role.
ALTER TABLE users
...
ALTER TABLE users
    MODIFY role ENUM('admin','admin2','technician','staff','student') NOT NULL DEFAULT 'student';

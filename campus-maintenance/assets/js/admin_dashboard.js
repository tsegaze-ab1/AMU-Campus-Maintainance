(function () {
  ...
  onReady(function () {
    ...
    if (rolesEl && window.Chart) {
      ...
      var roleData = (window.ADMIN_ROLE_DATA || { students: 0, technicians: 0, admins: 0 });
      ...
      new Chart(rolesEl, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Users',
            data: [roleData.students, roleData.technicians, roleData.admins],
            backgroundColor: [
              'rgba(' + cInfoRgb + ', .35)',
              'rgba(' + cWarningRgb + ', .35)',
              'rgba(' + cSuccessRgb + ', .35)'
            ],
            borderColor: [cInfo, cWarning, cSuccess],
            borderWidth: 1,
            borderRadius: 8,
            maxBarThickness: 44
          }]
